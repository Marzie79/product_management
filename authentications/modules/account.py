...
from authentications.modules.token import (
    get_token, block_token, update_token)
from utilities.exceptions import MultiLanguageException
from utilities.generic_functions import check_strong_password
from utilities.messages.error import (INVALID_PASSWORD, WEAK_PASSWORD)
...
def authenticate(email: str, password: str) -> Dict:
    ...
    try:
        ...
        if not check_strong_password(password=password):
